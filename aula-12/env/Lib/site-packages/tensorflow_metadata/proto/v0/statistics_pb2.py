...
CrossFeatureStatistics = _reflection.GeneratedProtocolMessageType('CrossFeatureStatistics', (_message.Message,), dict(
...
NumericCrossStatistics = _reflection.GeneratedProtocolMessageType('NumericCrossStatistics', (_message.Message,), dict(
...
StructStatistics = _reflection.GeneratedProtocolMessageType('StructStatistics', (_message.Message,), dict(
